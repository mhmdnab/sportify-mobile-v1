      ...
      >
        ...
        <View style={styles.dashHeader}>
          <View style={[styles.rolePill, { backgroundColor: isDark ? '#0C1832' : '#FFFFFF' }]}>
            <Ionicons name="person-outline" size={12} color={isDark ? '#A2B8FF' : colors.navy} />
            <Text style={[styles.rolePillText, { color: isDark ? '#A2B8FF' : colors.navy }]}>Manager</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  myVenuesCard: { flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 18, padding: spacing.md, marginBottom: spacing.md, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 1 },
